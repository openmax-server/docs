# Протокол мессенджера ТамТам
Протокол мессенджера ТамТам делится на два транспорта - [сокет](./transports/socket.md) и [вебсокет](./transports/websocket.md).
...
- [CHAT_INFO (48)](./opcodes/CHAT_INFO.md)
- CHAT_HISTORY (49)
- CHAT_MARK (50)
- CHAT_MEDIA (51)
- CHAT_DELETE (52)
...
- PUBLIC_SEARCH (60)
- CHAT_CREATE (63)
- [MSG_SEND (64)](./opcodes/MSG_SEND.md)
- [MSG_TYPING (65)](./opcodes/MSG_TYPING.md)
- MSG_DELETE (66)
- MSG_EDIT (67)
- CHAT_SEARCH (68)
...
- [NOTIF_MESSAGE (128)](./opcodes/NOTIF_MESSAGE.md)
- [NOTIF_TYPING (129)](./opcodes/NOTIF_TYPING.md)
- NOTIF_MARK (130)
- NOTIF_CONTACT (131)
- NOTIF_PRESENCE (132)
- NOTIF_CONFIG (134)
...
## Прогресс описания опкодов: 
- 9/115

## Авторизация
Авторизация по номеру телефона в протоколе выполняется через следующие опкоды:
- [SESSION_INIT (6)](./opcodes/SESSION_INIT.md)
- [AUTH_REQUEST (17)](./opcodes/AUTH_REQUEST.md)
- AUTH (18)
- LOGIN (19)